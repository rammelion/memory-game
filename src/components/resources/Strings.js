...
export const huStrings = new strings('Megoldás megmutatása', 'Újrakezdés', 'Gratulálunk!', 'Váltás magyar nyelvre', 'Váltás összeadásra', 'Váltás kivonásra', 'Váltás szorzásra', 'Váltás osztásra', 'Váltás angol nyelvre', 'Valóban nyelvet váltasz?');
export const usENStrings = new strings('Show results', 'Start over', 'Excellent!', 'Change to Hungarian', 'Change to English(US)', 'Change to addition', 'Change to subtraction', 'Change to multiplication', 'Change to division', 'Do you really want to change the language?');
